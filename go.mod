module vps-mount-gui

go 1.22

replace fyne.io/fyne/v2 => github.com/fyne-io/fyne/v2 v2.7.5-0.20260529084154-f5f48d2ab76e
...
replace golang.org/x/mod => github.com/golang/mod v0.12.0
...
replace fyne.io/systray => github.com/fyne-io/systray v1.12.1
